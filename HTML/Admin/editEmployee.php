                     ...
                     if($_SERVER["REQUEST_METHOD"] == "POST") 
  					 {
						...
						$sql = ' SELECT * FROM Employee_Records WHERE ID = "' . $SID .' " ';
                         $sql2 = ' SELECT * FROM Employee_Finance WHERE ID = "' . $SID .' " ';
						...
						if ($row_cnt > 0) 
							{	
								...
								echo "<br>";
								?>
								<form action="../../Include/updateuser.inc.php?ID=<?php echo $row['ID']; ?>" method="post">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="Username">Username</label>
                                <input type="text" class="form-control" id="Username" name="Username"value = "<?php echo $row['Username']; ?>" maxlength="25">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="number" class="form-control" id="Gross_Pay" name="Gross_Pay"value = "<?php echo $row2['Gross_Pay']; ?>">
                            </div>
                        </div>
